...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (ticketsSold >= 100) {
        ...
        maxTicketsBtn.style.display = 'none'
                ...
                <div class="ticket-content ticket-students ticket-students${ticketIndex}">
                    ...
                    <select class="list-students list-students${ticketIndex}">
                        ...
                        <optgroup label="GASTRONOMIA">
                            ...
                            <option value="Gastronomia - Julia Cristina Galvao Ribas">Júlia Cristina Galvão Ribas</option>
...
ticketsContainer.addEventListener("click", (event) => {
    if (event.target.classList.contains("delete-btn")) {
        ...
        if (ticket) {
            ...
            if (indexToRemove !== -1) {
                ticketsIndexes.splice(indexToRemove, 1)
            }
